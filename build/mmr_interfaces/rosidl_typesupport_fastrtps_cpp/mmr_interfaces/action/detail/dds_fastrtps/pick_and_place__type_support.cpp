...
#include "mmr_interfaces/action/detail/pick_and_place__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_Goal & ros_message)
{
  // Member: pick_pose
  {
    cdr >> ros_message.pick_pose;
  ...
  size_t current_alignment)
{
  ...
  // Member: pick_pose
  {
    ...
    size_t item_size = sizeof(ros_message.pick_pose[0]);
  ...
  // Member: place_pose
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.place_pose[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mmr_interfaces::action::PickAndPlace_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_Goal *>(
    untyped_ros_message);
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_Goal)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_Result)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: progress
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_Feedback & ros_message)
{
  // Member: progress
  cdr >> ros_message.progress;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_Feedback)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_Feedback__handle;
}
...
// functions for mmr_interfaces::action::PickAndPlace_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mmr_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_SendGoal_Request)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_SendGoal_Response)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal_Response__handle;
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_SendGoal)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_GetResult_Request)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for mmr_interfaces::action::PickAndPlace_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
  cdr << ros_message.status;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mmr_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_GetResult_Response)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult_Response__handle;
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_GetResult)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_GetResult__handle;
}
...
// functions for mmr_interfaces::action::PickAndPlace_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mmr_interfaces
cdr_serialize(
  const mmr_interfaces::action::PickAndPlace_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mmr_interfaces::action::PickAndPlace_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mmr_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_PickAndPlace_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces::action::PickAndPlace_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mmr_interfaces::action::PickAndPlace_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mmr_interfaces::action::PickAndPlace_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mmr_interfaces, action, PickAndPlace_FeedbackMessage)() {
  return &mmr_interfaces::action::typesupport_fastrtps_cpp::_PickAndPlace_FeedbackMessage__handle;
}
