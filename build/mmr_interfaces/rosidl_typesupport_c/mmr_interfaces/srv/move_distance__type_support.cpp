...
static const _MoveDistance_Request_type_support_symbol_names_t _MoveDistance_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, srv, MoveDistance_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mmr_interfaces, srv, MoveDistance_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mmr_interfaces, srv, MoveDistance_Request)() {
  return &::mmr_interfaces::srv::rosidl_typesupport_c::MoveDistance_Request_message_type_support_handle;
}
...
static const _MoveDistance_Response_type_support_symbol_names_t _MoveDistance_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, srv, MoveDistance_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mmr_interfaces, srv, MoveDistance_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mmr_interfaces, srv, MoveDistance_Response)() {
  return &::mmr_interfaces::srv::rosidl_typesupport_c::MoveDistance_Response_message_type_support_handle;
}
...
static const _MoveDistance_type_support_symbol_names_t _MoveDistance_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, srv, MoveDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mmr_interfaces, srv, MoveDistance)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mmr_interfaces, srv, MoveDistance)() {
  return &::mmr_interfaces::srv::rosidl_typesupport_c::MoveDistance_service_type_support_handle;
}
