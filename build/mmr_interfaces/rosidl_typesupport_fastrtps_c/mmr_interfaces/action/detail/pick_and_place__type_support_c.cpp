...
#include "mmr_interfaces/action/detail/pick_and_place__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // pick_pose, place_pose
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // pick_pose, place_pose

// forward declare type support functions


using _PickAndPlace_Goal__ros_msg_type = mmr_interfaces__action__PickAndPlace_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->pick_pose.size;
    auto array_ptr = ros_message->pick_pose.data;
  ...
  {
    size_t size = ros_message->place_pose.size;
    auto array_ptr = ros_message->place_pose.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pick_pose
  {
    ...
    if (ros_message->pick_pose.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->pick_pose);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->pick_pose, size)) {
      fprintf(stderr, "failed to create array for field 'pick_pose'");
      return false;
    }
    auto array_ptr = ros_message->pick_pose.data;
  ...
  // Field name: place_pose
  {
    ...
    if (ros_message->place_pose.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->place_pose);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->place_pose, size)) {
      fprintf(stderr, "failed to create array for field 'place_pose'");
      return false;
    }
    auto array_ptr = ros_message->place_pose.data;
    cdr.deserializeArray(array_ptr, size);
...
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name pick_pose
  {
    size_t array_size = ros_message->pick_pose.size;
    auto array_ptr = ros_message->pick_pose.data;
  ...
  // field.name place_pose
  {
    size_t array_size = ros_message->place_pose.size;
    auto array_ptr = ros_message->place_pose.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
...
static uint32_t _PickAndPlace_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mmr_interfaces__action__PickAndPlace_Goal;
    is_plain =
      (
...
static size_t _PickAndPlace_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_Goal)() {
...
using _PickAndPlace_Result__ros_msg_type = mmr_interfaces__action__PickAndPlace_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_Result__ros_msg_type * ros_message = static_cast<const _PickAndPlace_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_Result;
    is_plain =
      (
...
static size_t _PickAndPlace_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_Result)() {
...
using _PickAndPlace_Feedback__ros_msg_type = mmr_interfaces__action__PickAndPlace_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_Feedback__ros_msg_type * ros_message = static_cast<const _PickAndPlace_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_Feedback;
    is_plain =
      (
...
static size_t _PickAndPlace_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_Feedback)() {
...
// already included above
// #include "mmr_interfaces/action/detail/pick_and_place__functions.h"  // goal
...
using _PickAndPlace_SendGoal_Request__ros_msg_type = mmr_interfaces__action__PickAndPlace_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _PickAndPlace_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_mmr_interfaces__action__PickAndPlace_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mmr_interfaces__action__PickAndPlace_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_SendGoal_Request;
    is_plain =
      (
...
static size_t _PickAndPlace_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_SendGoal_Request)() {
...
using _PickAndPlace_SendGoal_Response__ros_msg_type = mmr_interfaces__action__PickAndPlace_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _PickAndPlace_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_SendGoal_Response;
    is_plain =
      (
...
static size_t _PickAndPlace_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_SendGoal)() {
...
using _PickAndPlace_GetResult_Request__ros_msg_type = mmr_interfaces__action__PickAndPlace_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_GetResult_Request__ros_msg_type * ros_message = static_cast<const _PickAndPlace_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_GetResult_Request;
    is_plain =
      (
...
static size_t _PickAndPlace_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_GetResult_Request)() {
...
// already included above
// #include "mmr_interfaces/action/detail/pick_and_place__functions.h"  // result
...
using _PickAndPlace_GetResult_Response__ros_msg_type = mmr_interfaces__action__PickAndPlace_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_GetResult_Response__ros_msg_type * ros_message = static_cast<const _PickAndPlace_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_mmr_interfaces__action__PickAndPlace_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mmr_interfaces__action__PickAndPlace_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_GetResult_Response;
    is_plain =
      (
...
static size_t _PickAndPlace_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_GetResult)() {
...
// already included above
// #include "mmr_interfaces/action/detail/pick_and_place__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _PickAndPlace_FeedbackMessage__ros_msg_type = mmr_interfaces__action__PickAndPlace_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t get_serialized_size_mmr_interfaces__action__PickAndPlace_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PickAndPlace_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _PickAndPlace_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_mmr_interfaces__action__PickAndPlace_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mmr_interfaces__action__PickAndPlace_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mmr_interfaces
size_t max_serialized_size_mmr_interfaces__action__PickAndPlace_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mmr_interfaces__action__PickAndPlace_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mmr_interfaces__action__PickAndPlace_FeedbackMessage;
    is_plain =
      (
...
static size_t _PickAndPlace_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mmr_interfaces__action__PickAndPlace_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mmr_interfaces, action, PickAndPlace_FeedbackMessage)() {
