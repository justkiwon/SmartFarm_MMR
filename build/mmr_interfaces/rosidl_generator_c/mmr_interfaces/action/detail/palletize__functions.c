...
mmr_interfaces__action__Palletize_Goal__init(mmr_interfaces__action__Palletize_Goal * msg)
{
  ...
  // pose_2d
  if (!rosidl_runtime_c__double__Sequence__init(&msg->pose_2d, 0)) {
    mmr_interfaces__action__Palletize_Goal__fini(msg);
    return false;
  }
  // num_points
  return true;
...
mmr_interfaces__action__Palletize_Goal__fini(mmr_interfaces__action__Palletize_Goal * msg)
{
  ...
  // pose_2d
  rosidl_runtime_c__double__Sequence__fini(&msg->pose_2d);
  // num_points
}
...
mmr_interfaces__action__Palletize_Goal__create()
{
  ...
  mmr_interfaces__action__Palletize_Goal * msg = (mmr_interfaces__action__Palletize_Goal *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_Goal));
  bool success = mmr_interfaces__action__Palletize_Goal__init(msg);
  if (!success) {
...
mmr_interfaces__action__Palletize_Goal__Sequence__init(mmr_interfaces__action__Palletize_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Goal * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_Goal *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_Goal__fini(&data[i - 1]);
      }
...
mmr_interfaces__action__Palletize_Goal__Sequence__fini(mmr_interfaces__action__Palletize_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Goal__Sequence * array = (mmr_interfaces__action__Palletize_Goal__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_Goal__Sequence__init(array, size);
  if (!success) {
...
mmr_interfaces__action__Palletize_Goal__Sequence__destroy(mmr_interfaces__action__Palletize_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_Goal__Sequence__are_equal(const mmr_interfaces__action__Palletize_Goal__Sequence * lhs, const mmr_interfaces__action__Palletize_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_Goal * data =
      (mmr_interfaces__action__Palletize_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_Goal__copy(
...
mmr_interfaces__action__Palletize_Result__init(mmr_interfaces__action__Palletize_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    mmr_interfaces__action__Palletize_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Result * msg = (mmr_interfaces__action__Palletize_Result *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_Result));
  bool success = mmr_interfaces__action__Palletize_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_Result__Sequence__init(mmr_interfaces__action__Palletize_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Result * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_Result *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_Result__Sequence__fini(mmr_interfaces__action__Palletize_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Result__Sequence * array = (mmr_interfaces__action__Palletize_Result__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_Result__Sequence__destroy(mmr_interfaces__action__Palletize_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_Result__Sequence__are_equal(const mmr_interfaces__action__Palletize_Result__Sequence * lhs, const mmr_interfaces__action__Palletize_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_Result * data =
      (mmr_interfaces__action__Palletize_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Feedback * msg = (mmr_interfaces__action__Palletize_Feedback *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_Feedback));
  bool success = mmr_interfaces__action__Palletize_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_Feedback__destroy(mmr_interfaces__action__Palletize_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mmr_interfaces__action__Palletize_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
mmr_interfaces__action__Palletize_Feedback__Sequence__init(mmr_interfaces__action__Palletize_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Feedback * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_Feedback *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_Feedback__Sequence__fini(mmr_interfaces__action__Palletize_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_Feedback__Sequence * array = (mmr_interfaces__action__Palletize_Feedback__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_Feedback__Sequence__destroy(mmr_interfaces__action__Palletize_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_Feedback__Sequence__are_equal(const mmr_interfaces__action__Palletize_Feedback__Sequence * lhs, const mmr_interfaces__action__Palletize_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_Feedback * data =
      (mmr_interfaces__action__Palletize_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mmr_interfaces__action__Palletize_SendGoal_Request__init(mmr_interfaces__action__Palletize_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mmr_interfaces__action__Palletize_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!mmr_interfaces__action__Palletize_Goal__init(&msg->goal)) {
    mmr_interfaces__action__Palletize_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
mmr_interfaces__action__Palletize_SendGoal_Request__fini(mmr_interfaces__action__Palletize_SendGoal_Request * msg)
{
  ...
  // goal
  mmr_interfaces__action__Palletize_Goal__fini(&msg->goal);
}
...
mmr_interfaces__action__Palletize_SendGoal_Request__are_equal(const mmr_interfaces__action__Palletize_SendGoal_Request * lhs, const mmr_interfaces__action__Palletize_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!mmr_interfaces__action__Palletize_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_SendGoal_Request * msg = (mmr_interfaces__action__Palletize_SendGoal_Request *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_SendGoal_Request));
  bool success = mmr_interfaces__action__Palletize_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_SendGoal_Request__Sequence__init(mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_SendGoal_Request * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_SendGoal_Request *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_SendGoal_Request__Sequence__fini(mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * array = (mmr_interfaces__action__Palletize_SendGoal_Request__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_SendGoal_Request__Sequence__destroy(mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_SendGoal_Request__Sequence__are_equal(const mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * lhs, const mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_SendGoal_Request * data =
      (mmr_interfaces__action__Palletize_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mmr_interfaces__action__Palletize_SendGoal_Response__init(mmr_interfaces__action__Palletize_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    mmr_interfaces__action__Palletize_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_SendGoal_Response * msg = (mmr_interfaces__action__Palletize_SendGoal_Response *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_SendGoal_Response));
  bool success = mmr_interfaces__action__Palletize_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_SendGoal_Response__Sequence__init(mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_SendGoal_Response * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_SendGoal_Response *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_SendGoal_Response__Sequence__fini(mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * array = (mmr_interfaces__action__Palletize_SendGoal_Response__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_SendGoal_Response__Sequence__destroy(mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_SendGoal_Response__Sequence__are_equal(const mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * lhs, const mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_SendGoal_Response * data =
      (mmr_interfaces__action__Palletize_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mmr_interfaces__action__Palletize_GetResult_Request__init(mmr_interfaces__action__Palletize_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mmr_interfaces__action__Palletize_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_GetResult_Request * msg = (mmr_interfaces__action__Palletize_GetResult_Request *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_GetResult_Request));
  bool success = mmr_interfaces__action__Palletize_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_GetResult_Request__Sequence__init(mmr_interfaces__action__Palletize_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_GetResult_Request * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_GetResult_Request *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_GetResult_Request__Sequence__fini(mmr_interfaces__action__Palletize_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_GetResult_Request__Sequence * array = (mmr_interfaces__action__Palletize_GetResult_Request__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_GetResult_Request__Sequence__destroy(mmr_interfaces__action__Palletize_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_GetResult_Request__Sequence__are_equal(const mmr_interfaces__action__Palletize_GetResult_Request__Sequence * lhs, const mmr_interfaces__action__Palletize_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_GetResult_Request * data =
      (mmr_interfaces__action__Palletize_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mmr_interfaces__action__Palletize_GetResult_Response__init(mmr_interfaces__action__Palletize_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!mmr_interfaces__action__Palletize_Result__init(&msg->result)) {
    mmr_interfaces__action__Palletize_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
mmr_interfaces__action__Palletize_GetResult_Response__fini(mmr_interfaces__action__Palletize_GetResult_Response * msg)
{
  ...
  // status
  // result
  mmr_interfaces__action__Palletize_Result__fini(&msg->result);
}
...
mmr_interfaces__action__Palletize_GetResult_Response__are_equal(const mmr_interfaces__action__Palletize_GetResult_Response * lhs, const mmr_interfaces__action__Palletize_GetResult_Response * rhs)
{
  ...
  // result
  if (!mmr_interfaces__action__Palletize_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_GetResult_Response * msg = (mmr_interfaces__action__Palletize_GetResult_Response *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_GetResult_Response));
  bool success = mmr_interfaces__action__Palletize_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_GetResult_Response__Sequence__init(mmr_interfaces__action__Palletize_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_GetResult_Response * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_GetResult_Response *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_GetResult_Response__Sequence__fini(mmr_interfaces__action__Palletize_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_GetResult_Response__Sequence * array = (mmr_interfaces__action__Palletize_GetResult_Response__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_GetResult_Response__Sequence__destroy(mmr_interfaces__action__Palletize_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_GetResult_Response__Sequence__are_equal(const mmr_interfaces__action__Palletize_GetResult_Response__Sequence * lhs, const mmr_interfaces__action__Palletize_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_GetResult_Response * data =
      (mmr_interfaces__action__Palletize_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mmr_interfaces__action__Palletize_FeedbackMessage__init(mmr_interfaces__action__Palletize_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mmr_interfaces__action__Palletize_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!mmr_interfaces__action__Palletize_Feedback__init(&msg->feedback)) {
    mmr_interfaces__action__Palletize_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
mmr_interfaces__action__Palletize_FeedbackMessage__fini(mmr_interfaces__action__Palletize_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  mmr_interfaces__action__Palletize_Feedback__fini(&msg->feedback);
}
...
mmr_interfaces__action__Palletize_FeedbackMessage__are_equal(const mmr_interfaces__action__Palletize_FeedbackMessage * lhs, const mmr_interfaces__action__Palletize_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!mmr_interfaces__action__Palletize_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_FeedbackMessage * msg = (mmr_interfaces__action__Palletize_FeedbackMessage *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mmr_interfaces__action__Palletize_FeedbackMessage));
  bool success = mmr_interfaces__action__Palletize_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_FeedbackMessage__Sequence__init(mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_FeedbackMessage * data = NULL;

  if (size) {
    data = (mmr_interfaces__action__Palletize_FeedbackMessage *)allocator.zero_allocate(size, sizeof(mmr_interfaces__action__Palletize_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mmr_interfaces__action__Palletize_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mmr_interfaces__action__Palletize_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mmr_interfaces__action__Palletize_FeedbackMessage__Sequence__fini(mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mmr_interfaces__action__Palletize_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * array = (mmr_interfaces__action__Palletize_FeedbackMessage__Sequence *)allocator.allocate(sizeof(mmr_interfaces__action__Palletize_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mmr_interfaces__action__Palletize_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mmr_interfaces__action__Palletize_FeedbackMessage__Sequence__destroy(mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mmr_interfaces__action__Palletize_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mmr_interfaces__action__Palletize_FeedbackMessage__Sequence__are_equal(const mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * lhs, const mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mmr_interfaces__action__Palletize_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mmr_interfaces__action__Palletize_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mmr_interfaces__action__Palletize_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mmr_interfaces__action__Palletize_FeedbackMessage * data =
      (mmr_interfaces__action__Palletize_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mmr_interfaces__action__Palletize_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mmr_interfaces__action__Palletize_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mmr_interfaces__action__Palletize_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
